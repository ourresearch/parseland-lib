...
Source:    parseland-eval/eval/data/merged-FINAL.csv  (read-only; lives in parseland-eval)
Filter:    rows whose DOI starts with "10.1016" (Elsevier registrant)
Sink:      parseland-lib/tests/fixtures/elsevier-10k-gold.ndjson
...
OUTPUT_PATH = Path(
    "/Users/shubh-trips/Documents/OpenAlex/parseland-lib/tests/fixtures/elsevier-10k-gold.ndjson"
)
